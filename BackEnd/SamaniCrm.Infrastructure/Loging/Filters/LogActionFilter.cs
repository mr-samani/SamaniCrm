...
public class LogActionFilter : IAsyncActionFilter
{
    ...
    public LogActionFilter(ILogService logService, IApplicationDbContext dbContext)
    {
    ...
    private LogContextDto BuildContext(ActionExecutingContext context, string correlationId)
    {
