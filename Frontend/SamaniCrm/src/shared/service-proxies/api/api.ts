...
export const APIS = [AccountServiceProxy, CaptchaServiceProxy, InitialServiceProxy, LanguageServiceProxy, RoleServiceProxy, UserServiceProxy, WeatherForecastServiceProxy];
