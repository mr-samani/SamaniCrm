...
import { InitialServiceProxy } from './initial.service';
...
export const APIS = [AccountServiceProxy, CaptchaServiceProxy, InitialServiceProxy, LanguageServiceProxy, MenuServiceProxy, RoleServiceProxy, UserServiceProxy, WeatherForecastServiceProxy];
