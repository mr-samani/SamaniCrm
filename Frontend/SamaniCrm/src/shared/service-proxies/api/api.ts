...
export const APIS = [AccountServiceProxy, CaptchaServiceProxy, CommonServiceProxy, LanguageServiceProxy, MenuServiceProxy, RoleServiceProxy, SecuritySettingsServiceProxy, UserServiceProxy, WeatherForecastServiceProxy];
