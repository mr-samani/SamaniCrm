...
@Component({
  selector: 'auto-complete-product-category',
  templateUrl: './auto-complete-category.component.html',
  styleUrls: ['./auto-complete-category.component.scss'],
  standalone: true,
  ...
  providers: [
    ProductServiceProxy,
    {
      ...
      useExisting: forwardRef(() => AutoCompleteProductCategoryComponent),
      multi: true,
    },
    {
      provide: NG_VALIDATORS,
      multi: true,
      useExisting: AutoCompleteProductCategoryComponent,
    },
  ],
})
export class AutoCompleteProductCategoryComponent
  ...
  implements OnInit, OnDestroy, ControlValueAccessor, Validator
{
  ...
  _filter(value: string): Observable<GuidAutoCompleteDto[]> {
    ...
    this.loading = true;
    return this.productService.getAutoCompleteProductCategory(filterValue).pipe(
