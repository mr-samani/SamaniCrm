...
export const SWIPER_SLIDE_BLOCK: SourceItem = {
  tag: 'swiper-slide',
  title: 'Swiper Slider',
  icon: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 218.207 218.207" style="enable-background:new 0 0 218.207 218.207;" xml:space="preserve">
<g>
	<g>
		<g>
